...
const batteryProducts = [
  ...
  { id: 3, name: 'Amaron Car Battery', size: 'Din 55 FLO', image: '/din55.jpeg' },
  { id: 4, name: 'Amaron Flo Car Battery', size: '40Ah', image: '/acar.png' },
  { id: 5, name: 'Amaron Go Car Battery', size: '35Ah', image: '/acargo.png' },
  { id: 6, name: 'Amaron Elito Car Battery', size: '35Ah', image: '/aelito.jpeg' },
  { id: 7, name: 'Exide Activa Battery', size: 'BTZ4LB', image: '/4lbe.jpeg' },
  { id: 8, name: 'Exide Activa Battery', size: 'BTZ5LB', image: '/5lbe.webp' },
  { id: 9, name: 'Exide Car Battery', size: '40Ah', image: '/ecar.jpeg' },
  { id: 10, name: 'Amaron Car Battery', size: '35Ah', image: '/96_96_Amaron FLO 36B20L.jpg' },
  { id: 11, name: 'Amaron Car Battery', size: '65Ah', image: '/amaron-car-battery-65ah.jpg' },
  { id: 12, name: 'Amaron Car Battery', size: '45Ah', image: '/amaron-car-battery-45ah.png' },
  { id: 13, name: 'Amaron Car Battery', size: '50Ah', image: '/amaron-car-battery-50ah.png' },
  { id: 14, name: 'Amaron Car Battery', size: '60Ah', image: '/amaron-car-battery-60ah.jpg' },
  { id: 15, name: 'Amaron Car Battery', size: '100Ah', image: '/heavy-duty-jcb-battery-150ah.png' },
  { id: 16, name: 'Exide Car Battery', size: '35Ah', image: '/exide-car-battery-35ah.jpg' },
  { id: 17, name: 'Exide Car Battery', size: '44Ah', image: '/exide-car-battery-44ah.jpg' },
  { id: 18, name: 'Exide Car Battery', size: '50Ah', image: '/exide-car-battery-50ah.jpg' },
  { id: 19, name: 'Amaron Pro Car Battery', size: 'Din 60', image: '/amaron-car-battery-65ah.jpg' },
  { id: 20, name: 'Amaron Pro Car Battery', size: 'Din 74', image: '/amaron-car-battery-45ah.png' },
  { id: 21, name: 'Amaron Hi-Life Car Battery', size: '45Ah', image: '/amaron-car-battery-50ah.png' },
  { id: 22, name: 'Amaron Hi-Life Car Battery', size: '50Ah', image: '/amaron-car-battery-60ah.jpg' },
  { id: 23, name: 'Amaron Black Car Battery', size: '35Ah', image: '/acar.png' },
  { id: 24, name: 'Amaron Pro Bike Rider', size: '9Ah', image: '/5lb.webp' },
  { id: 25, name: 'Exide Mileage Car Battery', size: '35Ah', image: '/ecar.jpeg' },
  { id: 26, name: 'Exide Mileage Car Battery', size: '45Ah', image: '/exide-car-battery-35ah.jpg' },
  { id: 27, name: 'Exide Matrix Car Battery', size: 'Din 55', image: '/exide-car-battery-44ah.jpg' },
  { id: 28, name: 'Exide Matrix Car Battery', size: 'Din 60', image: '/exide-car-battery-50ah.jpg' },
  { id: 29, name: 'Exide Epiq Car Battery', size: '35Ah', image: '/ecar.jpeg' },
  { id: 30, name: 'Exide Xplore Bike Battery', size: '9Ah', image: '/5lbe.webp' },
  { id: 31, name: 'Exide Xplore Bike Battery', size: '5Ah', image: '/4lbe.jpeg' },
  { id: 32, name: 'Exide Heavy Duty (JCB) Battery', size: '130Ah', image: '/heavy-duty-jcb-battery-150ah.png' },
  { id: 33, name: 'Exide Heavy Duty (JCB) Battery', size: '150Ah', image: '/heavy-duty-jcb-battery-150ah.png' },
  { id: 34, name: 'Amaron Heavy Duty (JCB) Battery', size: '130Ah', image: '/heavy-duty-jcb-battery-150ah.png' },
  { id: 35, name: 'Amaron Heavy Duty (JCB) Battery', size: '150Ah', image: '/heavy-duty-jcb-battery-150ah.png' },
  { id: 36, name: 'Exide Commercial Vehicle Battery', size: '100Ah', image: '/amaron-car-battery-65ah.jpg' },
  { id: 37, name: 'Amaron Commercial Vehicle Battery', size: '100Ah', image: '/amaron-car-battery-45ah.png' },
  { id: 38, name: 'Exide InvaTubular Battery', size: '150Ah', image: '/exide-car-battery-50ah.jpg' },
  { id: 39, name: 'Exide InvaTubular Battery', size: '200Ah', image: '/exide-car-battery-50ah.jpg' },
  { id: 40, name: 'Amaron Current Tubular Battery', size: '150Ah', image: '/amaron-car-battery-60ah.jpg' },
  { id: 41, name: 'Amaron Current Tubular Battery', size: '200Ah', image: '/amaron-car-battery-60ah.jpg' },
  { id: 42, name: 'Exide Matrix Car Battery', size: '65Ah', image: '/ecar.jpeg' },
  { id: 43, name: 'Amaron Pro Car Battery', size: '65Ah', image: '/acar.png' },
  { id: 44, name: 'Exide Mileage Car Battery', size: '55Ah', image: '/ecar.jpeg' },
  { id: 45, name: 'Amaron Hi-Life Car Battery', size: '55Ah', image: '/acar.png' },
  { id: 46, name: 'Exide Heavy Duty Truck Battery', size: '180Ah', image: '/heavy-duty-jcb-battery-150ah.png' },
  { id: 47, name: 'Amaron Heavy Duty Truck Battery', size: '180Ah', image: '/heavy-duty-jcb-battery-150ah.png' },
  { id: 48, name: 'Exide Mileage Car Battery', size: '52R', image: '/exide-car-battery-50ah.jpg' },
  { id: 49, name: 'Amaron Flo Car Battery', size: 'Din 60', image: '/amaron-car-battery-60ah.jpg' },
  { id: 50, name: 'Amaron Hi-Life Car Battery', size: '700RMF', image: '/amaron-car-battery-65ah.jpg' },
  { id: 51, name: 'Amaron Go Car Battery', size: '880 D 31 R', image: '/amaron-car-battery-65ah.jpg' }
];
