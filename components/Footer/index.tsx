        ...
        <div className="container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 py-12 px-4 md:px-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-4">
              <Link href="https://www.instagram.com/suman_tyres?igsh=bGl3amx4M2ViNXM5" className="text-gray-700 hover:text-black transition-colors duration-300" prefetch={false}>
